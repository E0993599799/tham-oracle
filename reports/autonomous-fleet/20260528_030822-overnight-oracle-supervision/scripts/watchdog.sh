...
LOG='/mnt/d/01 Main Work/Boots/Agentic AI/mission-control/tham-oracle/reports/autonomous-fleet/20260528_030822-overnight-oracle-supervision/logs/watchdog.log'
PROMPT='/mnt/d/01 Main Work/Boots/Agentic AI/mission-control/tham-oracle/reports/autonomous-fleet/20260528_030822-overnight-oracle-supervision/prompts/watchdog.md'
AGENT='watchdog'
RUNTIME='gemini'
mkdir -p "$(dirname "/mnt/d/01 Main Work/Boots/Agentic AI/mission-control/tham-oracle/reports/progress/watchdog.md")" "$(dirname "/mnt/d/01 Main Work/Boots/Agentic AI/mission-control/tham-oracle/reports/autonomous-fleet/20260528_030822-overnight-oracle-supervision/logs/watchdog.log")"
