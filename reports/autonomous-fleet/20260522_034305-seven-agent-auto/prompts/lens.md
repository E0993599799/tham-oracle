# lens — Gemini inspection lens / review and misplaced artifact audit
...
Progress file: reports/progress/lens.md. Start by writing 'Task received, starting now'. End with 'Task proof ready, awaiting verification' or 'BLOCKED'.
