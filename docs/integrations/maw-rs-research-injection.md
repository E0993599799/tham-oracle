# MAW-RS Research Injection for Tham Oracle

- injected_at: 20260521_184801
- source_repo: https://github.com/Soul-Brews-Studio/maw-rs
- source_path: /route/mission-control/backup/temp-time-load-doc/repos/maw-rs
- target_repo: /route/mission-control/tham-oracle
...
- Do not run cargo clippy from Tham-oracle unless Tham-oracle itself contains Cargo.toml.
- Do not run: git clone repo "https://github.com/..." because git treats repo as the repository URL.
- Correct form is: git clone https://github.com/Soul-Brews-Studio/maw-rs

## Integration Contract

- Tham remains brain/orchestrator.
- MAW-RS is executor/session substrate only.
- Flow: Intent Decode -> Memory Gate -> Risk Gate -> Contract -> Executor Lane -> Proof -> Writeback.
- Use /route/mission-control as WSL mission-control root.
